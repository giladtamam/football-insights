...
interface AppState {
  ...
  setSelectedFixture: (
    ...
    liveFixtureData?: LiveFixtureData | null
  ) => void;
...
export const useAppStore = create<AppState>()(
  persist(
    (set, get) => ({
      ...
      // Actions
      setSelectedLeague: (leagueId, seasonId) =>
        set({
      ...
      setSelectedFixture: (fixtureId, liveFixtureData) =>
        set({
      ...
      setMatchNote: (fixtureId, content, tags) =>
        set((state) => ({
          matchNotes: {
            ...state.matchNotes,
      ...
      setShowResponsibleGamblingModal: (show) =>
        set({ showResponsibleGamblingModal: show }),
